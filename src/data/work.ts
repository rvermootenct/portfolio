const data = [
  ...
  },
  {
    ...
    skills: [
      { id: 1, name: 'React', image: '/skills/react.png' },
      { id: 2, name: 'Next.js', image: '/skills/next-js.png' },
      { id: 3, name: 'React Native', image: '/skills/react-native.png' },
      { id: 4, name: 'Redux', image: '/skills/redux.png' },
      { id: 5, name: 'LaunchDarkly', image: '/skills/launch-darkly.png' },
  ...
  },
  {
    ...
    skills: [
      ...
      { id: 11, name: 'Ruby On Rails', image: '/skills/rails.png' },
