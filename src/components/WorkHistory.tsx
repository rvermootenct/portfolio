        ...
        <div className="mt-6 flex gap-x-6" key={work.id}>
          ...
          <div className='flex-1'>
            ...
            <div className="flex items-center gap-x-1">
              ...
              <span className="text-black dark:text-white capitalize text-sm font-bold mt-[]2px">{work.date}</span>
            </div>
            ...
            {work.options && <div className="mt-2">
              {work?.options?.map((option, index) => (
                <li key={index} className="text-zinc-900 dark:text-zinc-400 text-base font-semibold">{option}</li>
              ))}
              </div>}
          </div>
        </div>
